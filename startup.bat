...
set "javaDir=E:\devStuff\WebDev\coldfusion\lucee\jre"
rem for /f "tokens=2,*" %%d in ('reg query "%javaKey%\%javaVersion%" /v "JavaHome" 2^>nul') do set "javaDir=%%e"
