<cfcomponent extends="types.Driver" output="false" implements="types.IDatasource">
	...
	<cfset this.bundleName="mssqljdbc4">
	...
	<cffunction name="getName" returntype="string" output="no"
		...
		<cfreturn "Microsoft SQL Server (Vendor Microsoft)">
	</cffunction>
	...
	<cffunction name="getDescription" returntype="string" output="no"
		...
		<cfreturn "JDBC Driver from Microsoft for SQL Server, SQL Server is a relational database management system developed by Microsoft.">
	</cffunction>
